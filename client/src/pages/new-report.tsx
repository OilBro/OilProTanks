...
export default function NewReport() {
  ...
  const handlePreviewReport = () => {
    ...
    const previewReport: InspectionReport = {
      ...
      diameter: formData.diameter ? String(formData.diameter) : null,
      height: formData.height ? String(formData.height) : null,
      inspector: formData.inspector || '',
      inspectionDate: formData.inspectionDate || '',
      originalThickness: formData.originalThickness ? String(formData.originalThickness) : null,
      yearsSinceLastInspection: formData.yearsSinceLastInspection || null,
      status: 'draft',
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
      // Add all the other required fields with default values
      customer: null,
      location: null,
